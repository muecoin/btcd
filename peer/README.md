...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/muecoin/btcd/peer)
...
```bash
$ go get -u github.com/muecoin/btcd/peer
```

## Examples

* [New Outbound Peer Example](https://godoc.org/github.com/muecoin/btcd/peer#example-package--NewOutboundPeer)  
