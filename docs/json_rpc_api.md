...
* Unlike bitcoind that has the wallet and chain intermingled in the same process
  ...
  [btcwallet](https://github.com/muecoin/btcwallet).
...
such as [btcwallet](https://github.com/muecoin/btcwallet) for inter-process
...
[btcrpcclient](https://github.com/muecoin/btcrpcclient) package.
...
[btcrpcclient](https://github.com/muecoin/btcrpcclient) package to connect with
...
import (
	"github.com/muecoin/btcrpcclient"
