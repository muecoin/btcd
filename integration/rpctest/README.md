...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/muecoin/btcd/integration/rpctest)
...
```bash
$ go get -u github.com/muecoin/btcd/integration/rpctest
```
